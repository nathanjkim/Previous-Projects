 ...
 //sound elements
  ...
  //post:  reinitializes the battlefield and players when the round changes
   ...
   {   
      ...
      //boolean a = ((double)screenWidth >= 70);
      //boolean b = ((double)screenHeight >= 64);
      //boolean c = ((double)screenHeight <= 69);
      //boolean d = ((double)screenWidth <= 63);
      //if(a && b)
         //maxPower = 100;
      //else 
         //if(c && d)
            //maxPower = 50;
      maxPower = (int)((0.0007)(numRows*numColumns) + 1);
   	//******************************************************************************************************
